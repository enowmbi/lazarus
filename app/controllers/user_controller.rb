...
class UserController < ApplicationController
  ...
  def dashboard
    ...
    @first_time_login = Config.get_config_value('FirstTimeLoginEnable')
  ...
  def forgot_password
    ...
    @network_state = Config.find_by_config_key("NetworkState")
  ...
  def login
    @institute = Config.find_by(:config_key =>"LogoName")
