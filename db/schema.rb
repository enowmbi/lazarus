...
ActiveRecord::Schema.define(version: 0) do
  ...
  add_index "applicant_addl_field_groups", ["registration_course_id"], :name => "index_applicant_addl_field_groups_on_registration_course_id"
  ...
  add_index "applicant_addl_field_values", ["applicant_addl_field_id"], :name => "index_applicant_addl_field_values_on_applicant_addl_field_id"
  ...
  add_index "applicant_addl_fields", ["applicant_addl_field_group_id"], :name => "index_applicant_addl_fields_on_applicant_addl_field_group_id"
  ...
  add_index "applicant_addl_values", ["applicant_addl_field_id"], :name => "index_applicant_addl_values_on_applicant_addl_field_id"
  ...
  add_index "applicant_registration_settings", ["school_id"], :name => "index_applicant_registration_settings_on_school_id"
  ...
  add_index "archived_employee_additional_details", ["school_id"], :name => "index_archived_employee_additional_details_on_school_id"
  ...
  add_index "archived_employee_bank_details", ["school_id"], :name => "index_archived_employee_bank_details_on_school_id"
  ...
  add_index "archived_employee_salary_structures", ["school_id"], :name => "index_archived_employee_salary_structures_on_school_id"
  ...
  add_index "batches", ["is_deleted", "is_active", "course_id", "name"], :name => "index_batches_on_is_deleted_is_active_course_id_name"
  ...
  create_table "grn_items", :force => true do |t|
    ...
    t.integer  "quantity"
    t.numeric  "unit_price",    :limit => 10, :precision => 10, :scale => 0
    t.numeric  "tax",           :limit => 10, :precision => 10, :scale => 0
    t.date     "expiry_date"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "school_id"
  ...
  create_table "grns", :force => true do |t|
    ...
    t.date     "grn_date"
    t.date     "invoice_date"
    t.numeric  "other_chages",           :limit => 10, :precision => 10, :scale => 0
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "indent_items", :force => true do |t|
    ...
    t.numeric  "price",         :limit => 10, :precision => 10, :scale => 0
    t.integer  "required"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "school_id"
